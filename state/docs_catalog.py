...
DEFAULT_DOCUMENTS: list[dict[str, Any]] = [
    {
        ...
        "path": "docs/AE_Agentic_OpsSupport_Implementation_Guide_Part2.md",
        "displayOrder": 10,
        "active": True,
    },
    {
        ...
        "path": "docs/CONTROL_CENTER_GUIDE.md",
        "displayOrder": 15,
        "active": True,
    },
    {
        ...
        "path": "docs/AI_Studio_OnPrem_Agentic_Support_StepByStep(1).md",
        "displayOrder": 20,
        "active": True,
    },
]
