...
def test_tool():
    print("--- Testing check_workflow_status('Maturity_Claim') ---")
    result = check_workflow_status("Maturity_Claim")
    print(f"Bot Name: {result.get('bot_name')}")
    print(f"Total in history (24h): {result.get('total_executions_24h')}")
